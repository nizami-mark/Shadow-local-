...
export async function GET() {
  try {
    // Fetch the direct-download link for the Google Drive icon
    ...
    // Fallback redirect to an Unsplash avatar if fetch fails
    return NextResponse.redirect('https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=192&h=192&auto=format&fit=crop');
  }
}
